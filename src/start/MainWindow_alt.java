...
EventQueue.invokeLater(new Runnable() {
	...
	public MainWindow_alt() {
		...
		setIconImage(new ImageIcon(MainWindow_alt.class.getResource("/start/images/ic_launcher.png")).getImage());
		...
		lbLogo.setIcon(new ImageIcon(MainWindow_alt.class.getResource("/start/images/logo_final.png")));
		...
		lbTitel.setIcon(new ImageIcon(MainWindow_alt.class.getResource("/start/images/ic_launcher.png")));
